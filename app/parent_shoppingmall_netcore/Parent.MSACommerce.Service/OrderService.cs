...
using System.Linq;
using Parent.MSACommerce.Core;
using Parent.MSACommerce.Model;
using Parent.MSACommerce.Interface;
using Parent.MSACommerce.Model.DTO;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Storage;
using Parent.AgileFramework.Core;
using Parent.AgileFramework.Common.IOCOptions;
using Newtonsoft.Json;
using Parent.AgileFramework.Common.QueueModel;
using Parent.AgileFramework.Common;
using DotNetCore.CAP;

namespace Parent.MSACommerce.Service
{
