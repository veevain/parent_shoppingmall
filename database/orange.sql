...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单详情表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_seckill_order`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '秒杀订单标识',
  `user_id` bigint(20) NOT NULL COMMENT '用户编号',
  `order_id` bigint(20) NOT NULL COMMENT '秒杀订单号',
  `sku_id` bigint(20) NOT NULL COMMENT '秒杀商品ID',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_seckill_sku`  (
  ...
  `sku_id` bigint(20) NOT NULL COMMENT '秒杀的商品skuId',
  `title` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '秒杀商品标题',
  `seckill_price` bigint(20) NOT NULL COMMENT '秒杀价格',
  `image` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '秒杀商品图片',
  `start_time` datetime(0) NOT NULL COMMENT '秒杀开始时间',
  `end_time` datetime(0) NOT NULL COMMENT '秒杀结束时间',
  `enable` tinyint(1) NOT NULL COMMENT '是否允许秒杀 1-允许，0-不允许',
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = InnoDB AUTO_INCREMENT = 27359021743 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku表,该表表示具体的商品实体,如黑色的 64g的iphone 8' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '规格参数的分组表，每个商品分类下有多个规格参数组' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_spu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 197 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu表，该表描述的是一个抽象性的商品，比如 iphone8' ROW_FORMAT = DYNAMIC;
